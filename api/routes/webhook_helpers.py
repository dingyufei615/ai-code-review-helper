...
def _save_review_results_and_log(vcs_type: str, identifier: str, pr_mr_id: str, commit_sha: str, review_json_string: str, project_name_for_gitlab: str = None, repo_name_for_codeup: str = None):
    ...
    try:
        # 统一处理所有 github*, gitlab*, codeup* 类型
        if vcs_type.startswith('github'): # 包括 'github' 和 'github_general'
            ...
            save_review_results(vcs_type, identifier, pr_mr_id, commit_sha, review_json_string, repo_name=repo_name_for_codeup)
        else:
